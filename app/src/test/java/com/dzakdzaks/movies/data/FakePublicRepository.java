...
public class FakePublicRepository implements PublicDataSource {
    ...
    @Override
    public LiveData<List<MovieLocal>> getAllMovies(String apiKey, String language, String page) {
        MutableLiveData<List<MovieLocal>> movieResult = new MutableLiveData<>();

        remoteRepository.getAllMovies(apiKey, language, page, new RemoteRepository.LoadMoviesCallback() {
            @Override
